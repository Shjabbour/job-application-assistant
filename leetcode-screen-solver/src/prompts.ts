...
export function buildAnswerPrompt(
  ...
  return [
    ...
    "- In every code block, including first-try code, include concise comments using the requested language's normal comment syntax.",
    "- Make code comments spoken-friendly: each comment should explain the next step or invariant in words the candidate can say while typing.",
    "- Do not comment every obvious line. Prefer a few useful comments before key blocks, decisions, edge-case handling, and return values.",

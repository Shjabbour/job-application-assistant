...
export function buildAnswerRetryPrompt(answerPrompt: string): string {
  return [
    ...
    "Include the full live-interview talk track: clarifying questions, reasoning progression, pseudocode, typing narration, a dry run, and commented code.",
...
export function buildAnswerPrompt(
  ...
  return [
    "Prepare an interviewer-performance solution for the captured coding prompt.",
    "",
    ...
    "Prioritize correctness, readability, and the kind of visible thought process a candidate gives during a real mock interview.",
    "",
    "Return clean Markdown only.",
    "This answer page is a live-practice aid, not just a final solution. It must help the candidate keep talking while they solve.",
    "All sections appear in one scrollable answer page. Do not describe Naive First Try or Robust Answer as separate tabs.",
    ...
    "- Use ### Think While Solving for the chronological reasoning the candidate should say before and during coding.",
    "- The first visible section of every coding/debugging answer must be ## Pseudocode First.",
    "- In ## Pseudocode First, put the core solution in plain-English or language-light pseudocode before any opening script, prose explanation, or final code.",
    "- Use ### Pseudocode before final code inside the robust section as well. Pseudocode must be plain English or language-light steps the candidate can say out loud before typing real syntax.",
    "- Use ### Dry Run Out Loud for a small example walkthrough after code.",
    "- Clearly mark private/reference material with ### Keep In Mind or ## If Asked.",
    "- ### Say Out Loud, ### Think While Solving, ### Pseudocode, ### While Typing, and ### Dry Run Out Loud are all candidate-facing speech.",
    "- Keep reference-only sections short and clearly supportive.",
    ...
    "- Use more comments than normal production code: the candidate will be looking at the code while speaking, so comments should create a natural talk track.",
    "- For coding problems, aim for a useful comment before every logical cluster: edge-case setup, data-structure choice, loop invariant, key branch, state update, and final return.",
    ...
    "- Comments should explain why a block exists, not merely restate the syntax. Avoid filler comments like 'increment i'.",
    "- Do not jump from problem statement to final optimized code. Start with pseudocode, then show the communication path: clarify, brute-force, identify bottleneck, choose pattern, code, dry run, complexity.",
    ...
    "- Start coding/debugging answers with ## Pseudocode First. In that section, include ### Say Out Loud and a fenced `text` block with 5-10 pseudocode lines.",
    "- Put ## Say This First immediately after ## Pseudocode First as a practical opening script before solving.",
    "- In ## Say This First, include ### Restate, ### Ask, ### Brute Force, and ### Transition. Restate the task, ask 2-3 useful clarifying questions or confirm assumptions, briefly name the straightforward brute-force idea, then give one sentence that moves into improving it.",
    ...
    "- Include ## Naive First Try immediately after ## Hints. This is the first-try section: give the complete simple solution many candidates reach for.",
    "- In ## Naive First Try, include ### Say Out Loud, ### Think While Solving, ### First Try Pseudocode, ### First Try Code, ### First Try Complexity, and ### Why This May Not Be Enough.",
    "- ### First Try Pseudocode should be 4-8 simple steps that describe the brute-force or straightforward approach before syntax.",
    ...
    "- Include ## Robust Answer immediately after ## Naive First Try. This is the robust section: give the correct approach with words to say before showing code.",
    "- In ## Robust Answer, include ### Say Out Loud, ### Think While Solving, ### Pseudocode, ### While Typing, ### Dry Run Out Loud, and ### Keep In Mind. Do not add separate top-level Clarify or Approach sections.",
    "- ### Think While Solving must be a chronological talk track with 5-9 short bullets: what pattern is being recognized, what invariant is needed, why the chosen data structure works, and how edge cases are handled.",
    "- ### While Typing should map directly to the final code's commented blocks, so the candidate knows what to say as each block is typed.",
    "- ### Pseudocode must come before ### While Typing and should name the variables/data structures that will appear in the final code.",
    "- ### Dry Run Out Loud should walk through one compact example with the key variables or data structure states. Keep it short but concrete.",
    ...
    "- coding: Pseudocode First, Say This First, Hints, Naive First Try, Robust Answer, Code, Complexity, If Asked.",
    "- debugging: Pseudocode First, Say This First, Hints, Naive First Try, Robust Answer, Fix, Complexity, If Asked.",

...
export function buildAnswerPrompt(
  ...
  return [
    ...
    "- In the Code section, include concise comments using the requested language's normal comment syntax.",
    ...
    "- Include ## Naive First Try immediately after ## Hints. This is the first answer tab: give the simple answer many candidates reach for.",
    "- In ## Naive First Try, include ### Say Out Loud, ### While Typing, and ### Where It Breaks. Keep it plausible and useful, not intentionally broken.",
